...
macro_rules! generate_tag {
    ($($name:ident = $group:expr, $value:expr),*) => {
        $(
...
impl Tag {
    generate_tag! {
        ImageDescription = Group::IFD0, 0x010E,
        Make = Group::IFD0, 0x010F,
        Model = Group::IFD0, 0x0110,
        Software = Group::IFD0, 0x0131,
        Artist = Group::IFD0, 0x013B,
        Copyright = Group::IFD0, 0x8298
    }
}

pub struct Exif<'exif> {
    pub data: &'exif [u8],
